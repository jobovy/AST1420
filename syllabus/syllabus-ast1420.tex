...
\begin{itemize}
  ...
  \item {\bf Week 4:} Properties of disky mass distributions; orbits
    in axisymmetric potentials; surfaces of section; asymmetric drift;
    dark matter; rotation curves; gas kinematics in the Milky Way.

  \item {\bf Week 5:} Formation and evolution of dark matter halos;
    violent relaxation; phase-mixing.

  \item {\bf Week 6:} Spheroidal and triaxial mass distributions;
  ...
  \item {\bf Week 7:} chemical evolution of galaxies; age--abundance
    relations in the solar neighborhood; stellar population synthesis.

  \item {\bf Week 8:} Numerical methods; $N$-body modeling.

  \item {\bf Week 9:} Student presentations.

  \item {\bf Week 10:} Dynamical instabilities; bars; spiral arms.

  \item {\bf Week 11:} Mergers and dynamical friction; tides; review.
